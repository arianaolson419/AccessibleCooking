...
class TippedEntry(object):
    ...
    """
    def __init__(self, line, tip_id=None):
        self.text = line
        self.tip_id = tip_id

    def set_tip(self, tip_id):
        self.tip_id = tip_id
...
class TippedEntryField(db.Field):
    ...
    def wrap(self, value):
        ...
        return {"_type":type(value).__name__, "text":value.text, 'tip_id':value.tip_id}
    ...
    def unwrap(self, value):
        ...
        return mapping[value['_type']](value['text'], value['tip_id'])
